...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required title, isCompleted, createdAt, updatedAt}): _title = title, _isCompleted = isCompleted, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String title, bool? isCompleted}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'isCompleted': _isCompleted, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'isCompleted': _isCompleted, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
